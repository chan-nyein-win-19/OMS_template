            ...
            <div class="card p-5">
                ...
                <form id="newform" action="{{route('leaves.store')}}" method="POST">
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <button type="button" class="btn btn-outline-secondary mt-3 " style="padding:7px;" id="add">+Add</button>
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <button type="button" class="btn btn-outline-secondary mt-3 " style="padding:7px;" id="add1">+Add</button>
                ...
                <form id="newform" action="{{route('leaves.store')}}" method="post">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">EmployeeId*</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="employeeId" name=""
                                value="{{auth()->user()->employeeid}}" readonly>
                            <input type="hidden" class="form-control" id="userId" name="employeeId"
                                value="{{auth()->user()->id}}">
                        </div>
                    </div>
                    @error('employeeId')
