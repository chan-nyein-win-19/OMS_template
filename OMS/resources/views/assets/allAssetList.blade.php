    ...
    <div class="container-fluid">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link @if($activePC)active @endif" id="home-tab" data-bs-toggle="tab" data-bs-target="#pcList" type="button" role="tab" aria-controls="home" aria-selected="true">PCs</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link @if(!$activePC)active @endif" id="profile-tab" data-bs-toggle="tab" data-bs-target="#otherList" type="button" role="tab" aria-controls="profile" aria-selected="false">OtherAssets</button>
            </li>
        ...
        <div class="tab-content clearfix mt-5">
            <div class="tab-pane fade show @if($activePC)active @endif" id="pcList" role="tabpanel" aria-labelledby="home-tab">
                <a href='{{url("/allAssetList/updatePcPrice")}}' type="button" class="btn btn-primary mb-3">Update Price</a>
            ...
            <div class="tab-pane fade show @if(!$activePC)active @endif" id="otherList" role="tabpanel" aria-labelledby="home-tab">
                <a href='{{url("/allAssetList/updateOthersPrice")}}' type="button" class="btn btn-primary mb-3">Update Price</a>
