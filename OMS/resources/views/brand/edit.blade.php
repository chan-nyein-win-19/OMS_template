        ...
        <div class="card-body"><h5 class="card-title">Brand Update Form</h5>
            ...
            <form action="{{ route('brands.update',[$edit->id]) }}" method="post" >
                ...
                <div class="position-relative row form-group">
                        ...
                        <div class="col-sm-10">
                            <input id="name" type="text" class="form-control" name="name" value="{{ old('name') ? old('name') : $edit->name }}" placeholder="Please Enter Brand Name"  />
                    ...
                    <div class="position-relative row form-group">
                        <label for="content" class="col-sm-2 col-form-label">Description<span style="color: red">*</span></label>
                        <div class="col-sm-10">
                            <textarea id="description" type="textarea" class="form-control @error('description') @enderror" rows="3" name="description" placeholder="Please Enter Description" >{{ old('description') ? old('description') : $edit->description }}</textarea>
