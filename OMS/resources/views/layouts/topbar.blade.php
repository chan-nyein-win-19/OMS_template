<div class="app-header header-shadow">
    <div class="app-header__logo">
        <div class="logo-src mb-4">
            <span  style="font-size: 15px;font-style: italic;font-weight: bold;">OfficeManagement System</span>
        </div>
                            ...
                            <div class="btn-group">
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                    @if(isset(Auth::user()->employeeid))
                                        ...
                                        <button type="button" tabindex="0" class="dropdown-item"><a href="{{ url('/logout') }}" style="text-decoration: none">logout</a></button>
                                    @endif
                                </div>
                            </div>
                        </div>
