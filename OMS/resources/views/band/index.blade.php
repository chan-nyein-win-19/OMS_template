...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <h3 class="text-center mb-3">Band</h3>
                ...
                <div class="card p-3">
                    ...
                    @csrf              
                        <div class="position-relative row form-group">
                            <label class="col-sm-2 col-form-label"> Band No.
                                <span style="color: red">*</span>
                            </label>                        
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="bandno" value="{{ old('bandno') }}" 
                                    placeholder="Please Enter Band Number"/>
                                @error("bandno")
                                <span class="text-danger">{{ $errors->first('bandno') }}</span>
                                @enderror  
                            </div>
                        </div>
                    
                        <div class="position-relative row form-group">
                            <label class="col-sm-2 col-form-label"> Basic Salary
                                <span style="color: red">*</span>
                            </label>
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="basicsalary" value="{{ old('basicsalary') }}" 
        ...
        <hr>
        <div class="row mt-3">
            <table class="mb-0 table table-hover" id="band">
                <thead>
                    <tr>
                        <th>Band No.</th>
                        <th>Basic Salary</th>
                ...
                <tbody>  
                    @foreach ($list as $item)              
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('bands.edit', $item->id) }}" class="mb-2 mr-2 btn-transition btn btn-outline-primary"  data-toggle="tooltip" title="Edit">
                                    <i class="fa fa-fw"></i>
                                </a>
                                <form method="POST" action="{{ route('bands.destroy',['band'=>$item]) }}" id="form{{$item->id}}">
                                    @csrf
